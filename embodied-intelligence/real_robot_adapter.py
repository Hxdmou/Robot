...
BRAND_COMM_MAP = {
    ...
    # ── 补充31个产品映射 ──
    "athena_security_inspection": "platform_tcp",
    "chery_mojia_humanoid": "unitree_udp",
    "google_deepmind_gemini_robotics": "world_model_tcp",
    "guoxing_yuhang_xingsuan": "hpc_tcp",
    "huawei_cloudrobo_platform": "platform_tcp",
    "iluki_edu_companion_robot": "consumer_tcp",
    "kata_friends_companion_soft": "consumer_tcp",
    "mira_deep_principle_ai4s_scientist": "platform_tcp",
    "nvidia_isaac_gr00t": "platform_tcp",
    "optical_interconnect_three_stack_cpo_silicon": "wafer_tcp",
    "physical_intelligence_pi0": "world_model_tcp",
    "qingdao_port_robots": "energy_tcp",
    "qingtian_zhilian_training_humanoid": "unitree_udp",
    "sara_security_agent": "platform_tcp",
    "skild_ai_world_model": "world_model_tcp",
    "tianhe_space_supercomputing": "hpc_tcp",
    "tj_chenxing_embodied_debug": "unitree_udp",
    "tj_chenxing_parallel_delta": "industrial_tcp",
    "tj_hanhai_lanfan_underwater_night": "generic_bridge",
    "tj_moer_flexible_amr": "amr_tcp",
    "tj_shenzhilan_underwater_rov": "generic_bridge",
    "tj_wangyuan_pool_cleaner": "consumer_tcp",
    "ubtech_walker_s2_industrial": "unitree_udp",
    "wyndme_waimi_pro_home_butler": "consumer_tcp",
    "xingji_v": "unitree_udp",
    "xjtu_xunxiao_wheeled_dual_arm": "amr_tcp",
    "yuanjing_wulanchabu_stellar_supermonad": "hpc_tcp",
    "zhejiang_mingchu_ai_onsite_regulation": "platform_tcp",
