...
class RobotBrand(Enum):
    ...
    # ── 具身智能中试基地 ──
    HANGZHOU_EMBODIED_BASE = "杭州具身智能中试基地 (国家级应用基地, 40+场景, 真机遥操作+无本体数据采集, 宇树/魔芯/青瞳等入驻, 2026)"
    QINGTONG_ROBOT = "青瞳机器人科技 (杭州, 数据采集众包模式, 保洁保安真实作业采集, 2026)"
    CHUANHUA_ZHILIAN = "传化智联 (产业场景引入, 物流+制造场景验证, 2026)"
    # ── 能源大模型 ──
