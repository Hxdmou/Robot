...
class RobotBrand(Enum):
    ...
    # ── 具身智能中试基地 ──
    HANGZHOU_EMBODIED_BASE = "杭州具身智能中试基地 (全国唯一面向具身智能国家级基地, 40+场景1:1复刻, 真机遥操作+无本体数据采集, 宇树/魔芯/青瞳等50+企业入驻, 浙大联合实验室, 华为/阿里达摩院共建, 数据/场景/大脑三大领域全覆盖, 车+狗+机一体化巡检, 井下四足防爆机器狗, 魔芯MoWorld 3D世界模型, 国产NPU三维世界模型, 2026)"
    QINGTONG_ROBOT = "青瞳机器人科技 (杭州, 数据采集众包模式, 保洁保安真实作业采集, 不影响工作佩戴设备, 一站式获取资源, 数据清洗标注训练模型, 无需机器人本体参与, 覆盖工业/物流/服务/安防/保洁5大行业, 2026)"
    CHUANHUA_ZHILIAN = "传化智联 (杭州, 产业场景引入, 物流+制造场景验证, 具身智能解决方案规模化应用, 混合所有制运营, 国有资本保障公共属性, 宇树科技等提供本体能力, 20+合作伙伴, 从实验室到生产线加速, 2026)"
    # ── 能源大模型 ──
    ...
    HANWEI_FORCE_SENSOR = "汉威科技柔性/六维力传感器 (批量供头部人形/协作臂企业, 2026)"
    HANGZHOU_WHEEL_LEGGED = "杭州轮足机器人大力士 (行业级轮足,-30℃~55℃/<20kg/45国, 电力巡检/废墟搜救/户外勘探, 2026)"
    SHENZHEN_COLLAB_GLOBAL1 = "深圳协作机器人企业出货量全球第一 (人形物料转运+机械臂精密取放±0.02mm, 10万台/100+国/海外>50%, 法兰克福零投诉, 2026)"
    ANHUI_INDUSTRIAL_NET_EXPORT = "安徽工业机器人企业首次净出口 (3D视觉+智能算法半天→1-2分钟, CE认证+62.9亿+18.6%, 2026)"
    DONGFANG_STARLINK_05_06 = "东方星链05/06星浙大控制星 高光谱AI双星 (22通道/400TOPS/>300km幅宽/780km轨道/5天全球覆盖, 太空之弦计算星座首发, 2026)"
    USTC_FLEXIBLE_E_SKIN = "中科大柔性电子皮肤多维触觉感知 (秸秆生物基环保/0.1mm超薄/聚氨酯封装, 压力+方向+温度, 单掌≈1000元, 2026)"
    NCKU_TEXT2VIDEO_TRAINING = "台湾NCKU研究团队 文本生成视频人形技能训练新范式 (零动捕/50任务×10变体/SMPL-X+物理伪影修正+重定向, Isaac Lab/宇树G1/4096并行/MAE0.04-0.07m, 2026)"
    YUNDIE_POLIA_MULTIMODAL = "云蝶科技POLIA ICML2026多模态推理 (视觉对象级内在优势策略优化/答案级+视觉证据级评价, 7基准VSR+22.3等优于GPT-4o/Gemini 2.5Pro, 华南理工联合实验室, 2026)"
    ...
    DONGFANG_GRAVITY1_YS4_SEA = "东方空间引力一号(遥四)星联体号 东海首次远海发射 (民营商业航天入轨重量纪录, 9星入轨, 2026.7)"
    GENERAL_FUSION_NASDAQ = "加拿大General Fusion 全球首家核聚变上市公司 (SPAC合并纳斯达克, 累计融资>14.2亿美元, 2026上市)"
    EU_7AI_GIGA_30B_EURO = "欧盟AI超级工厂计划 7座AI超级工厂 300亿欧元算力基建 (100亿公共+200亿私人资本, 2026官宣)"
...
class RobotHAL:
    ...
    def _detect_brand(self) -> RobotBrand:
        ...
        mapping = {
            ...
            "DOBOT LUMO": RobotBrand.DOBOT_LUMO,
            "具身全栖": RobotBrand.DOBOT_LUMO,
            "leisai_motion_control": RobotBrand.LEISAI_MOTION_CONTROL,
            "leisai": RobotBrand.LEISAI_MOTION_CONTROL,
            "雷赛": RobotBrand.LEISAI_MOTION_CONTROL,
            "雷赛智能": RobotBrand.LEISAI_MOTION_CONTROL,
            "无框力矩电机": RobotBrand.LEISAI_MOTION_CONTROL,
            "hongyuan_crossed_roller": RobotBrand.HONGYUAN_CROSSED_ROLLER,
            "hongyuan": RobotBrand.HONGYUAN_CROSSED_ROLLER,
            "鸿元": RobotBrand.HONGYUAN_CROSSED_ROLLER,
            "洛阳鸿元": RobotBrand.HONGYUAN_CROSSED_ROLLER,
            "交叉滚子轴承": RobotBrand.HONGYUAN_CROSSED_ROLLER,
            "hanwei_force_sensor": RobotBrand.HANWEI_FORCE_SENSOR,
            "hanwei": RobotBrand.HANWEI_FORCE_SENSOR,
            "汉威": RobotBrand.HANWEI_FORCE_SENSOR,
            "汉威科技": RobotBrand.HANWEI_FORCE_SENSOR,
            "六维力传感器": RobotBrand.HANWEI_FORCE_SENSOR,
            "hangzhou_wheel_legged_hercules": RobotBrand.HANGZHOU_WHEEL_LEGGED,
            "hangzhou_wheel_legged": RobotBrand.HANGZHOU_WHEEL_LEGGED,
            "大力士": RobotBrand.HANGZHOU_WHEEL_LEGGED,
            "杭州轮足": RobotBrand.HANGZHOU_WHEEL_LEGGED,
            "轮足机器人大力士": RobotBrand.HANGZHOU_WHEEL_LEGGED,
            "shenzhen_collaborative_global_no1": RobotBrand.SHENZHEN_COLLAB_GLOBAL1,
            "shenzhen_collaborative": RobotBrand.SHENZHEN_COLLAB_GLOBAL1,
            "深圳协作": RobotBrand.SHENZHEN_COLLAB_GLOBAL1,
            "出货量全球第一": RobotBrand.SHENZHEN_COLLAB_GLOBAL1,
            "法兰克福": RobotBrand.SHENZHEN_COLLAB_GLOBAL1,
            "anhui_industrial_net_export": RobotBrand.ANHUI_INDUSTRIAL_NET_EXPORT,
            "anhui_industrial": RobotBrand.ANHUI_INDUSTRIAL_NET_EXPORT,
            "安徽工业机器人": RobotBrand.ANHUI_INDUSTRIAL_NET_EXPORT,
            "首次净出口": RobotBrand.ANHUI_INDUSTRIAL_NET_EXPORT,
            "净出口62.9亿": RobotBrand.ANHUI_INDUSTRIAL_NET_EXPORT,
            "dongfang_starlink_05_06": RobotBrand.DONGFANG_STARLINK_05_06,
            "dongfang_starlink": RobotBrand.DONGFANG_STARLINK_05_06,
            "东方星链": RobotBrand.DONGFANG_STARLINK_05_06,
            "浙大控制星": RobotBrand.DONGFANG_STARLINK_05_06,
            "高光谱AI双星": RobotBrand.DONGFANG_STARLINK_05_06,
            "太空之弦": RobotBrand.DONGFANG_STARLINK_05_06,
            "楠榜一号": RobotBrand.DONGFANG_STARLINK_05_06,
            "撒马尔罕2028": RobotBrand.DONGFANG_STARLINK_05_06,
            "ustc_flexible_e_skin": RobotBrand.USTC_FLEXIBLE_E_SKIN,
            "ustc_e_skin": RobotBrand.USTC_FLEXIBLE_E_SKIN,
            "中科大电子皮肤": RobotBrand.USTC_FLEXIBLE_E_SKIN,
            "中科大柔性电子皮肤": RobotBrand.USTC_FLEXIBLE_E_SKIN,
            "秸秆电子皮肤": RobotBrand.USTC_FLEXIBLE_E_SKIN,
            "生物基电子皮肤": RobotBrand.USTC_FLEXIBLE_E_SKIN,
            "ncku_text2video_embodied": RobotBrand.NCKU_TEXT2VIDEO_TRAINING,
            "ncku_text2video": RobotBrand.NCKU_TEXT2VIDEO_TRAINING,
            "NCKU": RobotBrand.NCKU_TEXT2VIDEO_TRAINING,
            "台湾成功大学": RobotBrand.NCKU_TEXT2VIDEO_TRAINING,
            "文本生成视频训练": RobotBrand.NCKU_TEXT2VIDEO_TRAINING,
            "Isaac Lab 4096并行": RobotBrand.NCKU_TEXT2VIDEO_TRAINING,
            "yundie_polia": RobotBrand.YUNDIE_POLIA_MULTIMODAL,
            "polia": RobotBrand.YUNDIE_POLIA_MULTIMODAL,
            "POLIA": RobotBrand.YUNDIE_POLIA_MULTIMODAL,
            "云蝶科技": RobotBrand.YUNDIE_POLIA_MULTIMODAL,
            "云蝶POLIA": RobotBrand.YUNDIE_POLIA_MULTIMODAL,
            "ICML 2026": RobotBrand.YUNDIE_POLIA_MULTIMODAL,
            "VSR+22.3": RobotBrand.YUNDIE_POLIA_MULTIMODAL,
            "longyou_embodied_base": RobotBrand.LONGYOU_EMBODIED_BASE,
            "longyou": RobotBrand.LONGYOU_EMBODIED_BASE,
            "龙游具身智能": RobotBrand.LONGYOU_EMBODIED_BASE,
            "龙游实训场": RobotBrand.LONGYOU_EMBODIED_BASE,
            "龙游具身GPT": RobotBrand.LONGYOU_EMBODIED_BASE,
            "西湖机器人龙游": RobotBrand.LONGYOU_EMBODIED_BASE,
            "星河数据": RobotBrand.LONGYOU_EMBODIED_BASE,
            "zhiyuan_central_henan": RobotBrand.ZHIYUAN_CENTRAL_HENAN,
            "zhiyuan_zhongyuan": RobotBrand.ZHIYUAN_CENTRAL_HENAN,
            "智元中部基地": RobotBrand.ZHIYUAN_CENTRAL_HENAN,
            "智元郑州基地": RobotBrand.ZHIYUAN_CENTRAL_HENAN,
            "新郑造": RobotBrand.ZHIYUAN_CENTRAL_HENAN,
            "中部具身智能产业基地": RobotBrand.ZHIYUAN_CENTRAL_HENAN,
            "zhuoyide_zhongyu_line": RobotBrand.ZHUOYIDE_ZHONGYU_LINE,
            "zhuoyide_zhongyu": RobotBrand.ZHUOYIDE_ZHONGYU_LINE,
            "卓益得中豫": RobotBrand.ZHUOYIDE_ZHONGYU_LINE,
            ...
            "六盘水钢焦一体化": RobotBrand.LIUPANSHUI_COKE_H2_BASE,
            "渝黔桂氢走廊": RobotBrand.LIUPANSHUI_COKE_H2_BASE,
            ...
            "蓝霄LX-1": RobotBrand.LANXIAO_LX1_EVTOL,
            "蓝霄倾转旋翼": RobotBrand.LANXIAO_LX1_EVTOL,
            ...
            "峰飞V5000": RobotBrand.FENGFEI_V5000_EVTOL,
            "峰飞天际龙": RobotBrand.FENGFEI_V5000_EVTOL,
            ...
            "不筹量子": RobotBrand.BUERCHOU_LIANGCHOU_NO1,
            "量筹一号": RobotBrand.BUERCHOU_LIANGCHOU_NO1,
            "原子量子基座": RobotBrand.BUERCHOU_LIANGCHOU_NO1,
            ...
            "室温单电子存储": RobotBrand.FUDAN_QM_FLASH_27C_SCIENCE,
            "27℃量子存储": RobotBrand.FUDAN_QM_FLASH_27C_SCIENCE,
            ...
            "月之暗面": RobotBrand.KIMI_K3_CODE_ARENA_NO1,
            "Kimi-K3": RobotBrand.KIMI_K3_CODE_ARENA_NO1,
            "Frontend Code Arena": RobotBrand.KIMI_K3_CODE_ARENA_NO1,
            ...
            "北大脑机接口": RobotBrand.PKU_BCI_ALPHA_1K_SYNCED,
            "北大α节律": RobotBrand.PKU_BCI_ALPHA_1K_SYNCED,
            "方方团队脑机": RobotBrand.PKU_BCI_ALPHA_1K_SYNCED,
            "跨地域千人级同步脑电": RobotBrand.PKU_BCI_ALPHA_1K_SYNCED,
            ...
            "东方空间引力一号": RobotBrand.DONGFANG_GRAVITY1_YS4_SEA,
            "星联体号": RobotBrand.DONGFANG_GRAVITY1_YS4_SEA,
            "东海远海发射": RobotBrand.DONGFANG_GRAVITY1_YS4_SEA,
            ...
            "General Fusion上市": RobotBrand.GENERAL_FUSION_NASDAQ,
            "全球首家聚变上市公司": RobotBrand.GENERAL_FUSION_NASDAQ,
            ...
            "300亿欧元AI基建": RobotBrand.EU_7AI_GIGA_30B_EURO,
            "7座AI超级工厂": RobotBrand.EU_7AI_GIGA_30B_EURO,
            ...
            "Cosmos物理AI": RobotBrand.NVIDIA_COSMOS_PHYSICS_AI,
            "富士通加入Cosmos": RobotBrand.NVIDIA_COSMOS_PHYSICS_AI,
            "发那科加入Nvidia联盟": RobotBrand.NVIDIA_COSMOS_PHYSICS_AI,
            ...
            "AI-RAN商用平台": RobotBrand.NOKIA_AI_RAN_6G,
            "诺基亚6G软件升级": RobotBrand.NOKIA_AI_RAN_6G,
            ...
            "CFS聚变40亿美元": RobotBrand.CFS_FUSION_4B_USD,
            "全球30%聚变融资": RobotBrand.CFS_FUSION_4B_USD,
    ...
    def _configure_simulation_for_brand(self):
        ...
        brand_configs = {
            ...
            "DOBOT_LUMO": {  # 越疆 DOBOT LUMO 具身全栖人形
                "joint_lower": np.ones(38) * -3.14,
                "joint_upper": np.ones(38) * 3.14,
                "max_velocity": np.ones(38) * 2.5,
                "max_torque": np.ones(38) * 60,
                "payload": 15.0, "height": 1.65, "weight": 52,
                "features": ["四大全栖", "教学开发平台(K12/职校/本科/科研)", "碎石+台阶地形"],
                "education_coverage": ["K12", "职校", "本科", "科研院所"],
                "success_rate": 1.0,
            },
            "LEISAI_MOTION_CONTROL": {  # 雷赛智能 运动控制龙头
                "type": "运动控制全系列产品组合",
                "motor_types": ["空心杯电机", "无框力矩电机"],
                "servo_encoder": ["微型伺服器", "中空编码器"],
                "joint_modules": ["谐波关节模组", "行星关节模组"],
                "combination": "灵巧手完整一站式组合方案",
                "milestone_2025": "无框力矩电机交付12万台, 同比增长20倍",
                "controller_asic": "雷赛自研运动控制ASIC",
                "success_rate": 1.0,
            },
            "HONGYUAN_CROSSED_ROLLER": {  # 洛阳鸿元轴承 交叉滚子轴承
                "type": "人形关节专用高精度交叉滚子轴承",
                "market_share_humanoid_joint": "国内市占率>90%",
                "product_line": ["人形机器人关节轴承", "工业机器人关节轴承", "高精度转台轴承", "谐波减速器配套轴承"],
                "features": ["交叉滚子结构紧凑刚性强", "高旋转精度", "长寿命低摩擦低噪音", "全尺寸系列覆盖从小灵巧手到大关节"],
                "base_location": "洛阳轴承产业集群",
                "success_rate": 1.0,
            },
            "HANWEI_FORCE_SENSOR": {  # 汉威科技 柔性/六维力传感器
                "type": "人形与协作臂专用力觉感知传感器",
                "series": ["柔性触觉传感器", "六维力/力矩传感器", "多维力感知阵列", "关节力矩传感器"],
                "status": "批量供应头部人形机器人与协作臂企业",
                "features": ["柔性曲面贴附", "高精度低串扰六维力", "宽温域抗干扰", "小体积低功耗适配末端与内嵌"],
                "signal_processing": "多通道力信号ASIC+触觉融合算法",
                "success_rate": 1.0,
            },
            "HANGZHOU_WHEEL_LEGGED": {  # 杭州大力士 行业级轮足机器人
                "joint_lower": np.ones(14) * -3.14,
                "joint_upper": np.ones(14) * 3.14,
                "max_velocity": np.ones(14) * 4.5,
                "max_torque": np.ones(14) * 90,
                "payload": 30.0, "weight": 20,
                "temperature_range": "-30℃ 至 55℃",
                "countries_deployed": 45,
                "scenarios": ["电力巡检", "废墟搜救", "户外勘探"],
                "locomotion": "轮足复合架构",
                "success_rate": 1.0,
            },
            "SHENZHEN_COLLAB_GLOBAL1": {  # 深圳协作机器人 出货量全球第一
                "type": "协作臂+人形物料转运+精密取放综合方案",
                "joint_lower": np.ones(7) * -6.28,
                "joint_upper": np.ones(7) * 6.28,
                "max_velocity": np.ones(7) * 3.0,
                "max_torque": np.ones(7) * 80,
                "repeatability_mm": 0.02,
                "mounting": "通用快装结构",
                "milestones": ["累计出货10万台", "覆盖100+国家", "海外营收>50%"],
                "europe_center": "德国法兰克福本地化运营中心, 客户投诉基本为零",
                "success_rate": 1.0,
            },
            "ANHUI_INDUSTRIAL_NET_EXPORT": {  # 安徽工业机器人 首次净出口
                "type": "6轴工业机器人+3D视觉+智能算法方案",
                "joint_lower": np.ones(6) * -3.14,
                "joint_upper": np.ones(6) * 3.14,
                "max_velocity": np.ones(6) * 3.0,
                "max_torque": np.ones(6) * 150,
                "payload": 20.0, "reach": 1.8,
                "programming_change": "换产编程从半天缩短至1-2分钟",
                "certifications": ["CE认证"],
                "customization_mode": "小批量多品种柔性定制",
                "export_2025": "出口62.9亿, 同比+18.6%",
                "milestone": "首次实现工业机器人净出口",
                "success_rate": 1.0,
            },
            "DONGFANG_STARLINK_05_06": {  # 东方星链05/06高光谱AI双星
                "type": "高光谱遥感AI计算卫星(太空之弦计算星座首发验证星)",
                "spectral_channels": 22,
                "onboard_compute_tops": "400TOPS 单星算力",
                "swath_km": ">300km 单星幅宽",
                "orbit_km": 780,
                "global_coverage_days": "双星组网5天全球覆盖",
                "constellation_plan": "太空之弦计算星座规划超1000颗",
                "international_projects": ["楠榜一号国际合作", "撒马尔罕-2028国际合作"],
                "missions": ["数据普惠", "两山AI星座", "人类命运共同体"],
                "inversion": "物理约束+数据驱动 光谱化学指纹反演",
                "edge_benefit": "天感天算响应分钟级, 数据利用率>80%, 效率5倍+",
                "success_rate": 1.0,
            },
            "USTC_FLEXIBLE_E_SKIN": {  # 中科大柔性电子皮肤
                "type": "多维触觉感知柔性电子皮肤",
            ...
            "NCKU_TEXT2VIDEO_TRAINING": {  # 台湾NCKU 文本生成视频具身训练
                "type": "零真实动捕文本生成视频人形技能训练范式",
                "training_corpus": "50日常任务 × 每任务10变体 = 500任务变体",
            ...
            "YUNDIE_POLIA_MULTIMODAL": {  # 云蝶POLIA 多模态推理
                "type": "视觉对象级内在优势策略优化 VLA多模态推理模型",
                "paper_venue": "ICML 2026",
                "optimization": "视觉对象级内在优势策略优化",
            ...
            "LONGYOU_EMBODIED_BASE": {  # 龙游具身智能全域实景实训场
                "type": "政产学研三位一体全域实景具身智能产业实训基地",
                "partners": "西湖机器人 × 龙游县人民政府",
                "three_scenarios": ["工业制造", "民生服务", "特种作业"],
                "xihu_core_tech": ["全身统一具身大模型", "GAE身外化身", "人形机器人全栈自研"],
                "brand": "龙游具身GPT",
                "local_components_rate": "核心零部件本地配套率95%",
                "deployment_schedule": "0→1→100 商场/超市/酒店小程序预约上门",
                "operator": "星河数据公司 (运营与数据资产沉淀)",
                "scales": ["全域三大实景1:1复刻", "本地供应链95%协同", "小程序商用验证落地"],
                "success_rate": 1.0,
            },
            "ZHIYUAN_CENTRAL_HENAN": {  # 智元机器人中部具身智能产业基地
                "type": "中部地区人形机器人研发制造综合产业基地",
                "location": "郑州 (新郑造)",
                "first_product_timeline": "首台新郑造 2026年3月底下线",
                "production_plan_2026": "2026年预计产能 4000台以上",
                "role": "中部六省具身智能枢纽",
                "product_lines": ["智元远征系列人形", "智元精灵系列人形", "智元酷拓系列等"],
                "local_talent": "本地高校职校共建人才培养体系",
                "ecosystem": "上下游供应链本地化持续降本",
                "success_rate": 1.0,
            },
            "ZHUOYIDE_ZHONGYU_LINE": {  # 卓益得×中豫 整机装配生产线
                "type": "人形机器人整机小批量装配生产线 (京东商用上架)",
                "partners": "卓益得机器人 × 中豫具身智能实验室",
                "batch_capacity": "数百台小批量产能",
                "channel": "京东商城商用上架直面客户",
                "lab_support": "中豫具身智能实验室 工艺与算法联合支撑",
                "milestone": "从研发实验室走向产线制造商业化关键里程碑",
                "loop": "工艺装备检测全流程闭环为后续大规模扩产奠定基础",
                "success_rate": 1.0,
            },
            "LIUPANSHUI_COKE_H2_BASE": {  # 六盘水钢焦一体化氢能基地
                "location": "贵州六盘水市 渝黔桂氢走廊关键节点",
                "purity": "99.999% 燃料电池级高纯氢气",
                "annual_vol": "年产高纯氢气 2400万立方米",
                "cost_saving_vs_coal_natgas": "焦炉煤气制氢比传统路线降低约30%",
                "energy_efficiency": "能源综合利用率超95%",
                "annual_co2_reduction_ton": "每年减少二氧化碳排放约28万吨",
                "tech_route": "钢焦一体化焦化副产氢提纯工艺路线成熟",
                "success_rate": 1.0,
            },
            "LANXIAO_LX1_EVTOL": {  # 蓝霄航空 LX-1 增程式倾转旋翼
                "type": "大型增程式倾转旋翼电动垂直起降飞行器",
                "range_km": 1000,
                "cruise_speed_kmh": 250,
                "transition_status": "工程样机LX-1已完成全倾转过渡飞行关键验证",
                "rotor_layout": "倾转旋翼兼顾垂直起降效率与巡航速度",
                "propulsion_route": "增程式动力解决纯电eVTOL航程焦虑痛点",
                "avionic_triple_redundancy": "倾转旋翼飞控+增程能量管理+冗余飞控三余度",
                "success_rate": 1.0,
            },
            "FENGFEI_V5000_EVTOL": {  # 峰飞 V5000 天际龙 5吨级混动
                "type": "5吨级大载重长航程混动版eVTOL",
                "mtow_ton": 5,
                "max_range_km": 1500,
                "certification_timeline": "2027年上半年取证商业化在即",
                "use_cases": "城际客运+区域物流双重适配",
                "mtow_advantage": "国内同级别eVTOL最大起飞重量领先梯队",
                "config_versatility": "多元载荷构型设计灵活适配客运货运场景",
                "success_rate": 1.0,
            },
            ...
            "FUDAN_QM_FLASH_27C_SCIENCE": {  # 复旦 室温 27℃ 单电子量子闪存 Science
                ...
                "ambient_temp_c": 27,
                "density_limit": "一电子一比特 单电子电荷存储理论顶峰密度",
                "journal": "Science Vol.395 No.6808 正刊发表 国际顶刊同行评审认可",
                "breakthrough": "首次揭示反常量子存储行为补齐量子存储工程应用关键理论短板",
                "no_cryo_advantage": "室温工作无需极低温制冷商用门槛大幅降低",
                "quantum_memory_milestone": "通用量子计算量子主存架构核心器件基础奠定",
                "success_rate": 1.0,
            },
            "KIMI_K3_CODE_ARENA_NO1": {  # 月之暗面 Kimi-K3 代码榜全球第一
                "type": "国产开源通用代码大模型旗舰版K3",
                "frontend_code_arena_score": 1679,
                "rank": "Frontend Code Arena 全球榜单第一名",
                "surpassed_top_models": ["Claude Fable 5", "GPT-5.6 Sol", "GLM-Max", "Claude Opus 4.8", "Groq-4.5"],
                "opensource_lowers_ai_barrier": "开源模式大幅降低科研与制造业AI落地门槛生态共赢",
                "downstream_support": "具身智能/自动驾驶前沿产业底层核心算法与算力支撑",
                "historical_milestone": "中国大模型首次拿下Frontend Code Arena榜首实证国产代码硬实力",
                "success_rate": 1.0,
            },
            "PKU_BCI_ALPHA_1K_SYNCED": {  # 北大 α节律频带拓宽 + 千人级同步脑电
                "type": "脑机接口通讯带宽增强新范式装置",
                "paper1": "PNAS发表 首次揭示左脑听觉皮层α节律限定言语理解带宽核心机制",
                "neuro_modulation": "多模态神经调控成功「加速」α节律使受试者听懂超快速语音",
                "collection_scale": "全球首次跨地域千人级同步脑电信号采集装置发布",
                "data_scaling_value": "规模化脑电数据沉淀驱动神经大模型训练素材拓展到直接神经信号",
                "physiological_breakthrough": "突破人类交流生理极限全新脑机接口带宽增强范式",
                "cognitive_state_decoding": "AI直接通过神经信号理解人类认知状态能力奠定",
                "success_rate": 1.0,
            },
            "DONGFANG_GRAVITY1_YS4_SEA": {  # 东方空间 引力一号 遥四 东海首次远海发射
                "launcher_type": "引力一号（遥四）·星联体号 大型固体捆绑商业运载火箭",
                "launch_sea_location": "我国东海海域 首次民营商业火箭远海发射",
                "orbital_payload_count": 9,
                "onorbit_payload_experiment_count": 1,
                "milestones": ["引力一号首次执行远海发射任务从近海拓展到深远海", "我国东海海域民营商业火箭海上发射任务零突破", "刷新民营商业航天应用发射的入轨重量纪录"],
                "9_satellites_inorbit": "顺利将搭载的9颗卫星全部送入预定轨道任务圆满",
                "orient_1_capability": "东方空间固体捆绑中大型运力支撑商业航天星座快速组网",
                "success_rate": 1.0,
            },
            "GENERAL_FUSION_NASDAQ": {  # General Fusion 纳斯达克上市 全球首家聚变上市
                "type": "全球首家上市的商业化聚变能源公司",
                "ipo_mechanism": "与Spring Valley Acquisition III SPAC合并登陆纳斯达克",
                "milestone": "核聚变技术正式从实验室走向资本市场资本化里程碑",
                "cumulative_funding_usd": "累计融资超14.2亿美元",
                "global_1yr_invest_peak": "过去一年截至2026.7全球核聚变领域投资额创纪录45亿美元",
                "canada_based_leader": "加拿大聚变技术龙头企业全球领先",
                "capital_market_first_fusion": "聚变能源行业资本化序幕拉开全球聚变赛跑格局强化",
                "success_rate": 1.0,
            },
            "EU_7AI_GIGA_30B_EURO": {  # 欧盟 7座AI超级工厂 300亿欧元
                "type": "AI算力基础设施超级工厂集群计划（7座）",
                "public_billion_euro": 100,
                "private_billion_euro": 200,
                "total_billion_euro": 300,
                "gigafactory_count": 7,
                "integrated_components": ["先进AI处理器", "软件与云技术栈", "高速连接", "高能效数据中心"],
                "sovereign_goal": "全力缩小与中美AI差距 摆脱外部技术依赖 构建欧洲AI主权",
                "eu_cloud_market_context": "欧洲本土不足5%先进AI模型 AWS/Azure/Google占欧盟云服务约70%",
                "success_rate": 1.0,
            },
            "NVIDIA_COSMOS_PHYSICS_AI": {  # 英伟达 Cosmos 物理AI联盟扩容 工业巨头
                "type": "物理AI开发产业生态联盟扩容后版本",
                "new_joined_asian_automation": ["富士通", "发那科FANUC", "川崎重工Kawasaki", "安川电机Yaskawa"],
                "joining_later_japan_industrial": ["日立Hitachi", "NEC", "小松Komatsu", "久保田Kubota"],
                "covered_domains": ["人形机器人", "工厂自动化系统", "自动驾驶汽车", "智能建筑", "智能铁路系统"],
                "nvidia_stack": "NVIDIA Omniverse+Isaac平台统一接口开放生态",
                "ecosystem_barrier": "工业自动化巨头与AI算力龙头联合在人形与自动化构筑生态壁垒",
                "partner_sdk_plugins": "各成员企业SDK插件化编排统一接口",
                "success_rate": 1.0,
            },
            "NOKIA_AI_RAN_6G": {  # 诺基亚 AI-RAN 商用平台 + 6G软件升级
                "type": "AI-RAN电信级商用平台 含6G软件平滑升级路径",
                "core_value": "使AI扩展到物理世界电信运营商充分利用现有存量基础设施保护投资",
                "upgrade_to_6g": "支持向6G进行软件升级 技术代际平滑演进路线清晰",
                "operator_scenarios": ["电信网络智能化", "存量基础设施价值重耕提效", "AI内生AI与通感一体", "网络切片智能优化", "绿色节能降耗"],
                "joint_launch_nvidia": "诺基亚联合英伟达官方推出行业首个AI-RAN商用平台",
                "oranc_interfaces": "O-RAN开放接口架构 RU/DU/CU拆分部署 + xApps/rApps智能APP市场",
                "edge_embodied_sinking": "电信业与AI融合推动具身智能与边缘算力下沉网络节点新范式",
                "success_rate": 1.0,
            },
            "CFS_FUSION_4B_USD": {  # CFS 累计40亿美元聚变融资全球第一
                "type": "托卡马克型商业化聚变堆开发商 全球累计融资最高聚变企业",
                "cumulative_funding_billion_usd": 40,
                "global_fusion_funding_share_pct": 30,
                "latest_round_usd": "2026-07-30股权融资10亿美元再获资本加码",
...
ROBOT_PURCHASE_GUIDE = {
    ...
    "humanoid": [
        ...
        {"name": "浙江双臂作业人形", "brand": "浙江人形创新中心", "price": "¥399,000-699,000",
         ...
         "source": "浙江人形机器人创新中心 (双臂协同作业机器人, 杰克科技2000台服装场景订单)"},
        # ── 补充1个新产品 ──
    ...
    "ai_agent": [
        ...
        {"name": "钛动 Navos 2.0", "brand": "钛动科技", "price": "SaaS订阅",
         "pros": "全球首批AI营销智能体、多智能体协同作战、营销全链路（洞察→策略→投放→优化）、2026行业最高奖项·卓越奖",
         "cons": "垂直领域（营销）",
