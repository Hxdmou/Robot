...
def find_model_file(path: str = None) -> Optional[str]:
    ...
    search_paths = [
        ...
        os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "embodied-intelligence/ppo_robot_reach_curriculum.zip"),
        os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "ppo_robot_reach_curriculum.zip"),
    ]
