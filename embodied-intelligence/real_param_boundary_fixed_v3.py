...
generate_boundary_report(
    report_filename=os.path.join(PROJECT_ROOT, "boundary_fixed_v3_report.txt"),
    log_filename=os.path.join(PROJECT_ROOT, "boundary_fixed_v3_log.csv"),
...
print("[BOUNDARY] 报告已生成: {output_path}/boundary_fixed_v3_report.txt")
