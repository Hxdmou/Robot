...
def content_page(prs, _, part_num, title, left_items, right_items, process_title, process_items):
    ...
    # 页脚垂直居中于页脚区
    tb(slide, 0, FOOTER_Y, SLIDE_W, SLIDE_H - FOOTER_Y, '具身智能&AI产业最新进展 · 2026年8月16日', sz=7, c=MGRAY, al=PP_ALIGN.CENTER, an=MSO_ANCHOR.MIDDLE)
...
def detail_page(prs, _, part_num, title, detail_title, detail_items):
    ...
    tb(slide, 0, FOOTER_Y, SLIDE_W, SLIDE_H - FOOTER_Y, '具身智能&AI产业最新进展 · 2026年8月16日 · 最新行情/研发/成果', sz=7, c=MGRAY, al=PP_ALIGN.CENTER, an=MSO_ANCHOR.MIDDLE)
...
def toc_page(prs):
    ...
    tb(slide, 0, SLIDE_H - 0.28, SLIDE_W, 0.2, '具身智能&AI产业最新进展 · 2026年8月16日 · 商务汇报', sz=8, c=MGRAY, al=PP_ALIGN.CENTER, an=MSO_ANCHOR.MIDDLE)
...
def cover_page(prs):
    ...
    tb(slide, block_start_x + btn_w + btn_gap, 6.0, date_w, 0.45, '2026年8月16日', sz=16, b=True, c=WHITE, al=PP_ALIGN.CENTER, an=MSO_ANCHOR.MIDDLE)
    # 底部装饰线
    rect(slide, 0, SLIDE_H - 0.36, SLIDE_W, 0.04, fc=GOLD)
...
def back_page(prs):
    ...
    # 底栏信息
    rect(slide, 0, SLIDE_H - 0.36, SLIDE_W, 0.04, fc=GOLD)
    tb(slide, 0, SLIDE_H - 0.28, SLIDE_W, 0.2, '具身智能&AI产业最新进展 · 2026年8月16日 · 商务汇报版', sz=8, c=MGRAY, al=PP_ALIGN.CENTER, an=MSO_ANCHOR.MIDDLE)
...
# ========== 双层水印 ==========
def add_watermark(prs, date_str='20260816'):
    wm_texts = [
        '机密文档 请勿传播 ' + date_str,
        '内部资料 版权所有 ' + date_str,
        '具身智能AI产业汇报 ' + date_str,
